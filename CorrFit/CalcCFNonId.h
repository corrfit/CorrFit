#ifndef _CORRFIT_CALCCF_NONID_H_
#define _CORRFIT_CALCCF_NONID_H_
...
class CalcCFNonId: public CalcCF
{
 public:
  CalcCFNonId();
  CalcCFNonId(Double_t aFitLow, Double_t aFitHigh, Int_t aFitBin,
	      Double_t aNormLow, Double_t aNormHigh);
  ~CalcCFNonId();
  CalcCFNonId& operator=(CalcCFNonId& aCalcCFNonId);
