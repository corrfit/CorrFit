#ifndef _CORRFIT_SOURCEMODELCMSHYPERBLAST_H_
#define _CORRFIT_SOURCEMODELCMSHYPERBLAST_H_

#include <TRandom.h>
#include "CFGlobal.h"
#include "SourceModel.h"

class SourceModelCMSHyperBlast: public SourceModel
{
 public:
  SourceModelCMSHyperBlast();
  ~SourceModelCMSHyperBlast();
