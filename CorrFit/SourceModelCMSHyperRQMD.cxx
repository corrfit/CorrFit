...
TRandom *SourceModelCMSHyperRQMD::mRandom = new TRandom();

SourceModelCMSHyperRQMD::SourceModelCMSHyperRQMD()
{
...
void       
SourceModelCMSHyperRQMD::SetModelParameters(double *aParTable)
{
...
double*
SourceModelCMSHyperRQMD::GetModelParameters()
{
  return mParameters;
}

void        
SourceModelCMSHyperRQMD::InitRandVar(double** aRandVar)
{
  Double_t tTemp;
...
void
SourceModelCMSHyperRQMD::GeneratePos(const VectorPair *aMom, VectorPair *aPos, double *aRandVar)
{
  aPos->part2.x=0.;
  aPos->part2.y=0.;
  aPos->part2.z=0.;
...
const char*       
SourceModelCMSHyperRQMD::GetParameterName(int aPar)
{
  switch (aPar) {
  case 0:
...
const char* 
SourceModelCMSHyperRQMD::GetModelIdentifier()
{
  return "SMExpHyperbolicCMSRQMD";
}

double 
SourceModelCMSHyperRQMD::GetHyper(Double_t aMu, Double_t aAlfa, Double_t aSigma, Double_t aHalfWide)
{
  Double_t tTemp;
  ...
  do {
    tTemp = (mRandom->Rndm()*20.0-10.0)*aHalfWide;
...
double 
SourceModelCMSHyperRQMD::GetHyperDouble(Double_t aMu1, Double_t aAlfa1, Double_t aSigma1, Double_t aMu2, Double_t aAlfa2, Double_t aSigma2, Double_t aHalfWide, Double_t aSwitch)
{
  Double_t tTemp;
  Double_t tVal, tArgSq;
...
inline double 
SourceModelCMSHyperRQMD::ScaleHyper(Double_t aScale, Double_t aX)
{
  return aX*aScale;
}
