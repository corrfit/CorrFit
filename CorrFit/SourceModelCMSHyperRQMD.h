#ifndef _CORRFIT_SOURCEMODELCMSHYPERRQMD_H_
#define _CORRFIT_SOURCEMODELCMSHYPERRQMD_H_
...
class SourceModelCMSHyperRQMD: public SourceModel
{
 public:
  SourceModelCMSHyperRQMD();
  ~SourceModelCMSHyperRQMD();
