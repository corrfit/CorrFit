#ifndef _CORRFIT_SOURCEMODELGAUSRINVJACOBIAN_H_
#define _CORRFIT_SOURCEMODELGAUSRINVJACOBIAN_H_
...
class SourceModelGausRInvJacobian: public SourceModel
{
 public:
  SourceModelGausRInvJacobian();
  ~SourceModelGausRInvJacobian();
