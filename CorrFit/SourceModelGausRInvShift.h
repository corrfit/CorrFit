#ifndef _CORRFIT_SOURCEMODELGAUSRINVSHIFT_H_
#define _CORRFIT_SOURCEMODELGAUSRINVSHIFT_H_
...
class SourceModelGausRInvShift: public SourceModel
{
 public:
  SourceModelGausRInvShift();
  ~SourceModelGausRInvShift();
