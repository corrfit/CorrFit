void Twavefunction_ppi::read_phaseshifts(){
  ...
  iqsmooth=1;
  qsmooth=25.0;
  fptr=fopen("wf/ppi_phaseshifts/s31.dat\0","r");
  ...
  iqsmooth=5;
  qsmooth=75.0;
  fptr=fopen("wf/ppi_phaseshifts/p31.dat\0","r");
  fgets(dummy,200,fptr);
  for(iread=0;iread<=60;iread++){
    fscanf(fptr,"%lf %lf",&plab,&deltaread[iread]);
    fgets(dummy,200,fptr);
  ...
  iqsmooth=5;
  qsmooth=75.0;
  fptr=fopen("wf/ppi_phaseshifts/p33.dat\0","r");
  fgets(dummy,200,fptr);
  for(iread=0;iread<=60;iread++){
    fscanf(fptr,"%lf %lf",&plab,&deltaread[iread]);
    fgets(dummy,200,fptr);
