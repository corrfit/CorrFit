// See wavefunction.cc for parent class
 ...
 Twavefunction_lambdalambda_antiparspin::Twavefunction_lambdalambda_antiparspin(char *parsfilename){
  int iq,ichannel;
  double q,q0;
...
double Twavefunction_lambdalambda_antiparspin::calcpsisquared(int iq,double r,double ctheta){
...
void Twavefunction_lambdalambda_antiparspin::GetPhaseshifts(){
  double q,q0;
